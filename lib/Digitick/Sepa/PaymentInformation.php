...
class PaymentInformation
{
    ...
    public function setControlSumCents($ctrsum)
    {
        $this->controlSumCents = $ctrsum;   
    }
     ...
     * @return void
     */
    public function setNumberOfTransactions($nbtx)
    {
        $this->numberOfTransactions = $nbtx;
    }
     ...
     * @param string $country
     */
    public function setCtgyPurposeCode($ctgyp)
    {
        $this->ctgy_purpose = $ctgyp;
    }

    /**
     * @return string
     */
    public function getCtgyPurposeCode()
    {
        return $this->ctgy_purpose;
    }
